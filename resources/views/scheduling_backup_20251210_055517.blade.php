...
<body>
    ...
    <script>
        // ==================== DEFINE ALL GLOBAL WINDOW FUNCTIONS FIRST ====================
        // These MUST be defined before any HTML elements try to call them via onclick
        
        console.log('=== INITIALIZING ADMIN SCHEDULING PAGE ===');
        ...
        console.log('All global functions defined successfully');
        console.log('openAddScheduleModal:', typeof window.openAddScheduleModal);
        console.log('closeModals:', typeof window.closeModals);
        console.log('switchTab:', typeof window.switchTab);
        console.log('viewSchedule:', typeof window.viewSchedule);
        ...
        // Test if Add Schedule button exists and is clickable
        const testButton = document.querySelector('button[onclick="openAddScheduleModal()"]');
        console.log('Add Schedule button found:', testButton ? 'YES' : 'NO');
        if (testButton) {
            console.log('Button onclick:', testButton.getAttribute('onclick'));
        ...
        console.log('openAddScheduleModal function exists:', typeof window.openAddScheduleModal);
